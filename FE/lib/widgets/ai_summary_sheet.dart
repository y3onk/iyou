...
class AISummarySheet extends StatelessWidget {
  ...
  Widget _panel(
          {required String title, required Widget child, Color? bg}) =>
      Container(
        padding: const EdgeInsets.all(16),
        decoration: BoxDecoration(
          color: bg ?? const Color(0xFFF6FFFB),
  ...
  Widget _disclaimer() => Container(
        ...
        child: const Row(
          ...
          children: [
            ...
            Expanded(
              child: Text(
                'AI 요약 안내\n이 요약은 iyou AI가 약관 내용을 분석하여 제공하는 참고용 정보입니다. '
                '정확한 내용은 전체 약관을 확인해주세요.',
